module DashboardHelper
  ...
  def link_to_hangup_call(sid)
    ...
    link_to_function image_tag('/redx.png', :style => "float: right; margin-right: -5px;" ), js, :confirm => "Hang up call?"
  end
  ...
  def link_to_toggle_mute_call(sid)
    ...
    link_to_function image_tag('/microphone.png', :style => "float: right; background: green; padding-right: -5px;" ), js
  end
